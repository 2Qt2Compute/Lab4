#############################################################################
# Makefile for building: dashBoardApplication
# Generated by qmake (3.1) (Qt 5.9.7)
# Project:  dashBoardApplication.pro
# Template: app
# Command: /home/logvv61/anaconda3/bin/qmake -o Makefile dashBoardApplication.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = dashBoardApplication1.0.0
DISTDIR = /home/logvv61/Qt\ Projects/dashBoardApplication/.tmp/dashBoardApplication1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/logvv61/anaconda3/lib
LIBS          = $(SUBLIBS) -L/home/logvv61/anaconda3/lib -lQt5Widgets -lQt5Gui -lQt5Network -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = resources/RAs.jpg \
		...
		dashBoardApplication.pro dashboard.h \
		httpmanager.h httpmanager.cpp \
		main.cpp \
		dashboard.cpp
QMAKE_TARGET  = dashBoardApplication
DESTDIR       = 
TARGET        = dashBoardApplication
...
Makefile: dashBoardApplication.pro ../../anaconda3/mkspecs/linux-g++/qmake.conf ../../anaconda3/mkspecs/features/spec_pre.prf \
		../../anaconda3/mkspecs/common/unix.conf \
		../../anaconda3/mkspecs/common/linux.conf \
		../../anaconda3/mkspecs/common/sanitize.conf \
		../../anaconda3/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents dashboard.h httpmanager.h $(DISTDIR)/
	$(COPY_FILE) --parents httpmanager.cpp main.cpp dashboard.cpp $(DISTDIR)/
...
qrc_images.cpp: images.qrc \
		../../anaconda3/bin/rcc \
		resources/09d@2x.png \
		resources/10d@2x.png \
		resources/reegs.jpg \
		resources/icon-ios7-refresh-128.png \
		resources/03d@2x.png \
		resources/Water_background.jpeg \
		resources/sunset.jpg \
		resources/01d@2x.png \
		resources/RAs.jpg \
		resources/13d@2x.png \
		resources/11d@2x.png \
		resources/Keeks.jpg \
		resources/04d@2x.png \
		resources/5k1.jpg \
		resources/8k.jpeg \
		resources/will.jpg \
		resources/5k_water.jpg \
		resources/50d@2x.png \
		resources/02d@2x.png
	/home/logvv61/anaconda3/bin/rcc -name images images.qrc -o qrc_images.cpp
...
moc_dashboard.cpp: ../../anaconda3/include/qt/QtWidgets/QMainWindow \
...
moc_httpmanager.cpp: ../../anaconda3/include/qt/QtCore/QObject \
		...
		moc_predefs.h \
		../../anaconda3/bin/moc
	/home/logvv61/anaconda3/bin/moc $(DEFINES) --include ./moc_predefs.h -I/home/logvv61/anaconda3/mkspecs/linux-g++ -I'/home/logvv61/Qt Projects/dashBoardApplication' -I/home/logvv61/anaconda3/include/qt -I/home/logvv61/anaconda3/include/qt/QtWidgets -I/home/logvv61/anaconda3/include/qt/QtGui -I/home/logvv61/anaconda3/include/qt/QtNetwork -I/home/logvv61/anaconda3/include/qt/QtCore -I/usr/include/c++/6 -I/usr/include/x86_64-linux-gnu/c++/6 -I/usr/include/c++/6/backward -I/usr/lib/gcc/x86_64-linux-gnu/6/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/6/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include httpmanager.h -o moc_httpmanager.cpp
...
ui_dashboard.h: dashboard.ui \
		../../anaconda3/bin/uic
	/home/logvv61/anaconda3/bin/uic dashboard.ui -o ui_dashboard.h
...
dashboard.o: dashboard.cpp dashboard.h \
		...
		../../anaconda3/include/qt/QtCore/QTimeZone \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/dashBoardApplication/bin || mkdir -p $(INSTALL_ROOT)/opt/dashBoardApplication/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/dashBoardApplication/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/dashBoardApplication/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/dashBoardApplication/bin/ 
